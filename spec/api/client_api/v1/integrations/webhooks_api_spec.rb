...
RSpec.describe ClientAPI::V1::Integrations::WebhooksAPI, type: :api do
  describe 'POST /v1/integrations/webhooks' do
    ...
    context 'when webhook is received with success' do
      ...
      it 'returns created address' do
        post "/api/v1/integrations/webhooks/#{webhook.provider}", params: request_params
